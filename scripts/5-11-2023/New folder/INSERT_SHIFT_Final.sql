...
0, 0, 0, '', 1, SG.AUTO_MID_NIGHT_FIX, @SFTDefaultCal, NULL, SG.LATE_COVER, SG.BRK_ALLOW_LATE_HRS_CALC, SG.ALLOW_DEDCT_OUT_HRS
...
INSERT INTO [HS_TA_SHIFTDEF_DAY_CONFIG]
		   ...
		   ,[SFT_DEMPBRK_HRS_FRMOT])
SELECT RIGHT('000000'+CAST(@SFTCodeCal + ROW_NUMBER() OVER (ORDER BY [ID]) AS varchar(25)),6), 
0, SG.NEXT_DAY_SHIFT_OUT_TIME, SG.FLEXI_SHIFT, SG.CONTINUE_SHIFT, SG.OFF_SHIFT, '#3f6b98', 1, 
SG.START_TIME, SG.END_TIME, SG.FIRST_HALF_DUR, SG.SECOND_HALF_DUR, SG.LEAVE_DAYS, SG.AUTO_MID_NIGHT_FIX, 
SG.START_TIME, SG.END_TIME , 1, 1,
10.0, 0.0, 10.0, 0.0, 1, 1, SG.LATE_COVER, SG.ALLOW_DEDCT_OUT_HRS
FROM  HS_HR_IA_SHIFT_INFO_UPLOAD SG

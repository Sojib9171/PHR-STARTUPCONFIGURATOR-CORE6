CREATE OR ALTER PROCEDURE [QADBV9_L2].[SP_IA_UPDT_SHRT_WIZ_UPLD_TXT]
@ID INT,
@COLUMN_NO INT,
@DATA NVARCHAR(MAX)
AS
...
ELSE
BEGIN
SET @QUERY='UPDATE [QADBV9_L2].[HS_HR_IA_SHORT_LEAVE_UPLOAD] SET ['+@COLUMN_NAME+'] = '''+@DATA+''' WHERE [ID]='+CAST(@ID as nvarchar)+';'
END

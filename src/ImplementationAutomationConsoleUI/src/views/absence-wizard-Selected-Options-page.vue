          ...
          <div class="page-body">
            ...
            <section class="mt-3">
              ...
              <div class="section-body">
                <absenceWizardSelectedOptions :subsection="this.subsectionName"></absenceWizardSelectedOptions>
              </div>
            </section>
          </div>
        </div>
...
import AbsenceWizardSelectedOptions from '@/components/pageElements/AbsenceWizardSelectedOptions.vue';
//import $ from 'jquery';
...
export default {
  ...
  components: {
    ...
    "topBar": TopBar,
    "loader": PageLoader,
    "absenceWizardSelectedOptions": AbsenceWizardSelectedOptions
  },

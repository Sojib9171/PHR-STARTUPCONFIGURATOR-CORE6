          ...
          <div class="page-body">
            ...
            <section class="mt-3">
              ...
              <div class="section-body">
                <absenceWizardEditedOptions :subsection="this.subsectionName" :id="this.id"></absenceWizardEditedOptions>
              </div>
            </section>
          </div>
        </div>
...
import AbsenceWizardEditedOptions from '@/components/pageElements/AbsenceWizardEditedOptions.vue';
//import $ from 'jquery';
...
export default {
  ...
  components: {
    ...
    "loader": PageLoader,
    "absenceWizardEditedOptions": AbsenceWizardEditedOptions
  },

          ...
          <div class="page-title">
            ...
            <nav style="--bs-breadcrumb-divider: '|';" aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><router-link :to="{ name: 'admin-approval-summary' }"></router-link>
                  Admin Approval Summary</li>
              </ol>
            </nav>
          </div>
        </div>
...
import AdminApprovalSummaryTable from "../components/pageElements/AdminApprovalSummaryTable.vue";
...
export default {
  data: function () {
    return {
      pageName: "Summary for Admin Approval",
      isLoading: false,
  ...
  components: {
    "sideBar": SideBar,
    "topBar": TopBar,
    "AdminApprovalSummaryTable": AdminApprovalSummaryTable,
    "loader": PageLoader
  },

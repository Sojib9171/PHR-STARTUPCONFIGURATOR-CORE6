          ...
          <div class="page-body">
            ...
            <section class="mt-3">
              <div class="section-heading">
                ...
                <h4 class="subtitle">For {{ subsection }}</h4>
              </div>
              <div class="section-body">
                <uploadTemplate :subsectionName="subsection" @api-response="handleApiResponse" />
              </div>
...
import UploadTemplate from "../components/pageElements/UploadTemplate.vue";

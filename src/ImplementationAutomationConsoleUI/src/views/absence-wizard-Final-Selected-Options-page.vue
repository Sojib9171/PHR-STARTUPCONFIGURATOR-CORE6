<template>
  <div>
    ...
    <div v-else>
      <div>
        <sideBar :isDisabled="true" :allObjects="allObjects" :emiObjects="eimObjects" :absenceObjects="absenceObjects" />
        <div class="col page-content px-0">
          ...
          <div class="page-body">
            ...
            <section class="mt-3">
              ...
              <div class="section-body" v-if="sideComponentLoaded">
                <absenceWizardFinalSelectedOptions :subsection="this.subsectionName" :rowId="this.rowId">
                </absenceWizardFinalSelectedOptions>
              </div>
            </section>
          </div>
        </div>
...
import AbsenceWizardFinalSelectedOptions from '@/components/pageElements/AbsenceWizardFinalSelectedOptions.vue';
//import $ from 'jquery';
...
export default {
  ...
  components: {
    ...
    "topBar": TopBar,
    "loader": PageLoader,
    "absenceWizardFinalSelectedOptions": AbsenceWizardFinalSelectedOptions
  },

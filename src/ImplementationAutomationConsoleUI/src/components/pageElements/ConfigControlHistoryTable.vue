<template>
    <div>
        <button @click="showModal = true" type="button" id="historyBtn" class="btn btn-primary" data-bs-toggle="modal"
            data-bs-target="#cnfgCntrlHistryModal" hidden>
        </button>
        <!-- Modal -->
        <div class="modal fade" id="cnfgCntrlHistryModal" tabindex="-1" aria-labelledby="cnfgCntrlHistryModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="cnfgCntrlHistryModalLabel">Configuration Control History</h5>
                        ...
                        <div>
                            ...
                            <vue-good-table mode="remote" v-on:page-change="onPageChange"
                                ...
                                <template #table-row="props">
                                    <span v-if="props.column.field == 'approval_comment'">
...
export default {
    ...
    methods: {
        ...
        loadItems() {
            this.$http.get(`/getConfigControlHistory?serverParams=${encodeURIComponent(JSON.stringify(this.serverParams))}`, {
                headers: {
                    accept: "*/*",
                    Authorization:
                        "Basic " +

<template>
    <div>
        <button @click="showModal = true" type="button" id="historyBtn" class="btn btn-primary" data-bs-toggle="modal"
            data-bs-target="#adminApprovalUserModal" hidden>
        </button>
        <!-- Modal -->
        <div class="modal fade" id="adminApprovalUserModal" tabindex="-1" aria-labelledby="adminApprovalUserModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="adminApprovalUserModalLabel">Approval History - {{ subsectionName }}
                        </h5>
